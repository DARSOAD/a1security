				...
				<div class="morph-dropdown-wrapper">
					...
					<div class="panel-group pmd-accordion pmd-accordion-nospace tablet celular" id="accordion5" role="tablist" aria-multiselectable="true" > 
						<div class="panel panel-default"> 
							<a href="<?php echo get_site_url(); ?>/"><img src="<?php echo get_template_directory_uri(); ?>/imagenes/iconos/LOGO.png" alt="Logo A1 security" class="logo_movil tablet celular"></a> 
						</div>
						<div class="panel panel-default"> 
