...
<div id="bloque3" class="banner-full-screen" id="lp-form">
    ...
    <form id="theForm" class="classic-form" action="<?php echo get_site_url(); ?>/?page_id=33" method="post" accept-charset="UTF-8" autocomplete="off">
        ...
        <div class="form-group">
            ...
            <input id="c1" name="company" type="text" required>
        </div>
        <div class="form-group">
            <label for="c2">Phone number</label>
            <input id="c2" name="phone" type="tel" required>
        </div>
        <div class="form-group">
            <label for="c3">Work Email</label>
            <input id="c3" name="email" type="email" required>
        </div>
        <div class="form-group">
            <label for="c4">Your Name</label>
            <input id="c4" name="firstname" type="text" required>
        </div>
        <div class="form-group">
            <label for="c6">Additional information (Optional)</label>
            <textarea id="c6" name="message" rows="3"></textarea>
        </div>
