...
<div id="bloque3" class="banner-full-screen" style="height: auto !important; padding: 60px 20px; text-align: center;">
    ...
    <form id="theForm" class="classic-form" action="<?php echo get_site_url(); ?>/?page_id=33" method="post" accept-charset="UTF-8" autocomplete="off">
        ...
        <div class="form-group">
            ...
            <input id="q1" name="company" type="text" required placeholder="VENUE / COMPANY NAME *">
        </div>
        <div class="form-group">
            <label for="q2">Phone number</label>
            <input id="q2" name="phone" type="tel" required placeholder="PHONE NUMBER *">
        </div>
        <div class="form-group">
            <label for="q3">Work Email</label>
            <input id="q3" name="email" type="email" required placeholder="WORK EMAIL *">
        </div>
        <div class="form-group">
            <label for="q4">Your Name</label>
            <input id="q4" name="firstname" type="text" required placeholder="YOUR NAME *">
        </div>
        <div class="form-group">
            <label for="q6">Additional information</label>
            <textarea id="q6" name="message" rows="2" placeholder="HOW CAN WE HELP YOU?"></textarea>
        </div>
